        ...
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="ui-basic">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="/Addsong">Add Song</a></li>
              <li class="nav-item"> <a class="nav-link" href="/Viewsong">View Song</a></li>
            </ul>
          </div>
        </li>
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="ui-basic">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="/AddAlbums">Add Albums</a></li>
              <li class="nav-item"> <a class="nav-link" href="/ViewAlbums">View Albums</a></li>
            </ul>
          </div>
        </li>
        <li class="nav-item menu-items">
          <a class="nav-link" data-bs-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
            ...
            <span class="menu-title">Artiest</span>
            <i class="menu-arrow"></i>
          </a>
          <div class="collapse" id="ui-basic">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="/AddArtiest">Add Artiest</a></li>
              <li class="nav-item"> <a class="nav-link" href="/ViewArtiest">View Artiest</a></li>
            </ul>
          </div>
        </li>
        {{-- <li class="nav-item menu-items">
